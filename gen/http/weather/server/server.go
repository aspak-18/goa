...
func (s *Server) MethodNames() []string { return weather.MethodNames[:] }
...
// MountShowHandler configures the mux to serve the "weather" service "show"
// endpoint.
