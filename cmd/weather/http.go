...
import (
	"context"
	weathersvr "example/gen/http/weather/server"
...
func handleHTTPServer(ctx context.Context, u *url.URL, weatherEndpoints *weather.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
